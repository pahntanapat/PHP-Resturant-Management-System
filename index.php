...
<div id="title" class="ui-corner-top pageContent"><!-- InstanceBeginEditable name="title" -->ยินดีต้อนรับ<!-- InstanceEndEditable --></div>
<div class="pageContent" id="content"><!-- InstanceBeginEditable name="content" -->ยินดีต้อนรับ <?=@$sess->empID.': '.@$sess->name?><!-- InstanceEndEditable --></div>
