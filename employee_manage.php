...
if(Config::isAjax(Session::SEC_EMPY))
...
<div id="title" class="ui-corner-top pageContent"><!-- InstanceBeginEditable name="title" -->จัดการพนักงาน<!-- InstanceEndEditable --></div>
<div class="pageContent" id="content"><!-- InstanceBeginEditable name="content" -->
    <form action="employee_manage.scr.php" method="get" name="form" target="_blank" id="form"><p><span class="buttonset"><button id="checkAll" data-checked="0" type="button">เลือกทั้งหมด</button>
    <a href="employee_manage.php" id="refresh">refresh</a><a href="#edit" data-id="0">เพิ่มพนักงาน</a><button type="button" id="stop_work">หยุดทำงาน</button><button type="button" id="del">ลบ</button>
    </span>&nbsp;
